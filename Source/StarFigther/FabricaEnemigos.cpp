...
AEnemigo* AFabricaEnemigos::FabricarEnemigo(FString TipoEnemigo)
{
	//Create the Potion and log its name
	AEnemigo* Enemigo = EnemigoFabricado(TipoEnemigo);
	GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow, FString::Printf(TEXT("Concocting %s"), *Enemigo->GetNombre()));
