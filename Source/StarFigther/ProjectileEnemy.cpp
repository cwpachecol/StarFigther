...
void AProjectileEnemy::Fight()
{
	...
	Super::Fight();
	GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow,	TEXT("The enemy blows a kiss and fires a gun"));
}
...
void AProjectileEnemy::Die()
{
	...
	Super::Die();
	GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow,	TEXT("The enemy writhes in agony and disintegrates even more"));
}